...
function userpopup_menu() {
    if (jQuery(".usermenu_area", "#header").length > 0) {
        ...
        userpopUpHTML += '<form action="users/login" method="post" name="login_form" class="formValid">';
        userpopUpHTML += '<ul class="formList">';
        userpopUpHTML += '<li class="icon formLogin"><input type="text" id="login" name="username" value="" placeholder="Login" required></li>';
        userpopUpHTML += '<li class="icon formPass"><input type="password" id="password" name="password" value="" placeholder="Password" required></li>';
        userpopUpHTML += '<li class="remember">';
        userpopUpHTML += '<a href="#forgot-popUp" class="user-popup-link forgotPwd">Forgot password?</a>';
        userpopUpHTML += '<input type="checkbox" value="1" id="rememberme" name="remember_me">';
        userpopUpHTML += '<label for="rememberme">Remember me</label>';
        userpopUpHTML += '</li>';
        userpopUpHTML += '<li><input type="submit" value="Login" class="sendEnter enter"></li>';
        userpopUpHTML += '</ul>';
        userpopUpHTML += '</form>';
        userpopUpHTML += '</div>';
        ...
        userpopUpHTML += '<form name="register_form" action="users/register" method="post" class="formValid">';
        userpopUpHTML += '<div class="itemformLeft">';
        userpopUpHTML += '<ul class="formList">';
        userpopUpHTML += '<li class="icon formUser"><input type="text" id="registration_name" name="name" value="" placeholder="Name" required></li>';
        userpopUpHTML += '<li class="icon formUser"><input type="text" id="registration_username" name="username" value="" placeholder="User name (login)" required></li>';
        userpopUpHTML += '<li class="icon formPass"><input type="password" id="registration_pwd" name="password" value="" placeholder="Password" required></li>';
        userpopUpHTML += '<li class="i-agree">';
        userpopUpHTML += '<input type="checkbox" value="1" id="i-agree" name="i-agree" required>';
        userpopUpHTML += '<label for="i-agree">I agree with Terms &amp; Conditions</label>';
        userpopUpHTML += '</li>';
        userpopUpHTML += '<li><input type="submit" class="sendEnter enter" value="Sign Up" ></li>';
        userpopUpHTML += '</ul>';
        userpopUpHTML += '</div>';
        userpopUpHTML += '<div class="itemformRight">';
        userpopUpHTML += '<ul class="formList">';
        userpopUpHTML += '<li class="icon formLogin"><input type="email" id="registration_email" name="email" value="" placeholder="E-mail" required></li>';
        userpopUpHTML += '<li class="icon formUser"><input type="text" id="registration_phone" name="phone" value="" placeholder="Phone"></li>';
        userpopUpHTML += '<li class="icon formPass"><input type="password" id="registration_pwd2" name="confirm_password" value="" placeholder="Confirm Password" required></li>';
        userpopUpHTML += '</ul>';
        userpopUpHTML += '</div>';
        userpopUpHTML += '</form>';
        userpopUpHTML += '<div class="result messageBlock"></div>';
        ...
        userpopUpHTML += '<div id="forgot-popUp" class="user-popUp mfp-with-anim mfp-hide">';
        userpopUpHTML += '<div class="sc_tabs">';
        userpopUpHTML += '<ul class="loginHeadTab">';
        userpopUpHTML += '<li style="width:100%;"><a href="#forgotForm" class="loginFormTab icon">Forgot Password</a></li>';
        userpopUpHTML += '</ul>';
        userpopUpHTML += '<div id="forgotForm" class="formItems loginFormBody">';
        userpopUpHTML += '<div class="col-md-11">';
        userpopUpHTML += '<form action="users/forgot" method="post" name="login_form" class="formValid">';
        userpopUpHTML += '<ul class="formList">';
        userpopUpHTML += '<li class="icon formLogin"><input type="email" id="email" name="email" value="" placeholder="Email" required></li>';
        userpopUpHTML += '<li class="icon"><input type="submit" value="Submit" class="sendEnter enter submitBtn"></li>';
        userpopUpHTML += '<li class="icon">';
        userpopUpHTML += '<a href="#user-popUp" class="user-popup-link fa-sign-out" style="color:#428bca;"> Back to login</a>';
        userpopUpHTML += '</li>';
        userpopUpHTML += '</ul>';
        userpopUpHTML += '</form>';
        userpopUpHTML += '</div>';
