...
<section class="content-header">
    <h1>
        Manage Guardians
        <small>All Guardians List</small>
    </h1>
</section>
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-fw fa-circle-o"></i> <span
                            class="caption-subject font-green bold uppercase">Guardians</span></h3>
                    <div class="box-tools">
                        <?php echo $this->Html->link("<i class=\"fa fa-plus\"></i> " . __('Add Guardian'), ["action" => "add"], ["class" => "btn btn-block btn-primary", "escape" => false]); ?>
                    </div>
                </div>
                <!-- /.box-header -->
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?= $this->Paginator->sort('home_nmber') ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if ($guardian->created != "") echo $guardian->created->format('d-M-Y'); ?></td>
                                <td><?php if ($guardian->modified != "") echo $guardian->modified->format('d-M-Y'); ?></td>
                                <td class="actions">
                                    <?= $this->Html->link(__('<i class="fa fa-fw fa-eye"></i> View'), ['action' => 'view', $guardian->id], ['class' => 'btn btn-primary btn-sm', 'escape' => false]) ?>
                                    <?= $this->Html->link(__('<i class="fa fa-edit"></i> Edit'), ['action' => 'edit', $guardian->id], ['class' => 'btn btn-success btn-sm', 'escape' => false]) ?>
                                    <?= $this->Form->postLink('<i class="fa fa-trash"></i> Delete', ['action' => 'delete', $guardian->id], ['confirm' => __('Are you sure you want to delete # {0}?', $guardian->id), 'class' => 'btn btn-danger btn-sm', 'escape' => false]) ?>
                                </td>
                            </tr>
                            <?php endforeach;
                            else:
                                echo "<tr> <td colspan='6' align='center'> <strong>No Guardian Found</strong> </td> </tr>";
                            endif;
                            ?>
                        </tbody>
                    </table>
