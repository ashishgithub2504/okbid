...
<section class="content-header">
    <h1>
        Manage Images 
        <small>Update Image Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit Image') ?></h3>
        </div><!-- /.box-header -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('type', ['class' => 'form-control', 'placeholder' => ucfirst('type'), 'label' => ['text' => ucfirst('type'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
