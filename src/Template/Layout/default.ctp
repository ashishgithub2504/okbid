...
<body class="theme_skin_kinder">
    ...
    <?php
        echo $this->Html->script([
            'front/vendor/jquery-1.11.3.min.js', 
            'front/vendor/bootstrap.min.js',
            'front/vendor/jquery.ui.totop.js', 
            'front/main/__packed.js',
            'front/main/shortcodes_init.js',
            'front/main/_main.js',
            'front/vendor/jquery.elevateZoom-3.0.8.min.js'
            ]);
    ?>
