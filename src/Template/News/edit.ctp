...
<section class="content-header">
    <h1>
        Manage News 
        <small>Update News Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit News') ?></h3>
        </div><!-- /.box-header -->
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('short_desc', ['class' => 'form-control', 'placeholder' => ucfirst('short_desc'), 'label' => ['text' => ucfirst('short_desc'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('description', ['class' => 'form-control', 'placeholder' => ucfirst('description'), 'label' => ['text' => ucfirst('description'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
