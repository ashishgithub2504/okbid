...
<section class="content-header">
    <h1>
        Manage Paddocks 
        <small>Update Paddock Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit Paddock') ?></h3>
        </div><!-- /.box-header -->
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('paddock_number', ['class' => 'form-control', 'placeholder' => ucfirst('paddock Number'), 'label' => ['text' => ucfirst('paddock Number'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('location', ['class' => 'form-control', 'placeholder' => ucfirst(' Paddock location'), 'label' => ['text' => ucfirst(' Paddock location'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
