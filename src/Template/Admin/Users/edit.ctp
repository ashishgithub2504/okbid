...
<?php echo $this->Form->input('company', ['class' => 'form-control', 'label' => ['text' => ucfirst('Company Name')]]); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">         
<?php echo $this->Form->input('password1', ['class' => 'form-control', 'name' => 'password', 'value' => '', 'placeholder' => ucfirst('password'), 'autocomplete' => 'off', 'label' => ['text' => ucfirst('password'), 'class' => 'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
...
<?php echo $this->Form->input('profile_pic_file', ['class' => 'form-control', 'type' => 'file', 'label' => ['text' => ucfirst('Profile Pic'), 'class' => 'req']]); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">         
<?= $this->Html->image(_BASE_ . 'uploads/users/' . $user->profile_pic, ['width' => '50px']); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
