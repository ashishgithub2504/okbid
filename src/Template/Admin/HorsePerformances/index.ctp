                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?= $this->Paginator->sort('event_name','Event Name') ?></th>
                                <th scope="col"><?= $this->Paginator->sort('running_date') ?></th>
                                <th scope="col"><?= $this->Paginator->sort('sponsor') ?></th>
                                <th scope="col"><?= $this->Paginator->sort('place','Position') ?></th>
...
<!--                                <th scope="col"><?= $this->Paginator->sort('created') ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($horsePerformances as $key=>$horsePerformance): ?>
                            <tr>
                                <td><?= $number+($key+1); ?></td>
                                ...
                                <td><?= $horsePerformance->has('rider') ? $this->Html->link($horsePerformance->rider->name, ['controller' => 'Riders', 'action' => 'view', $horsePerformance->rider->id]) : '' ?></td>
                                <td><?= h($horsePerformance->event_name) ?></td>
                                <td><?= h($horsePerformance->running_date->format('d-M-Y')) ?></td>
                                ...
                                <td><?= ($horsePerformance->status == 1)?'Active':'InActive'; ?></td>
