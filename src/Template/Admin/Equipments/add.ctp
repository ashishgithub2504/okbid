...
<section class="content-header">
    <h1>
        Manage Equipments 
        <small>Create New Equipment</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Add Equipment') ?></h3>
        </div><!-- /.box-header -->
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('image_file', ['type'=>'file','class' => 'form-control', 'placeholder' => ucfirst('image'), 'label' => ['text' => ucfirst('image'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
