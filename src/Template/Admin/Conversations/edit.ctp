...
<section class="content-header">
    <h1>
        ...
        <small>Update Conversation Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit Conversation') ?></h3>
        </div><!-- /.box-header -->
        <?php echo $this->Form->create($conversation, ['id'=>'validateform','role' => 'form', 'enctype' => 'multipart/form-data']); ?>
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
