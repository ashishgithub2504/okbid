    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('venue', ['autocomplete' => 'off','class' => 'form-control', 'placeholder' => ucfirst('venue'), 'label' => ['text' => ucfirst('venue'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('name', ['autocomplete' => 'off','class' => 'form-control', 'placeholder' => ucfirst('event Name'), 'label' => ['text' => ucfirst('event Name'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
