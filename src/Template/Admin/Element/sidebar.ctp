    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <?php if (in_array($this->request->session()->read('Auth.admin.role_id'), array('1', '5'))) { ?>
                ...
                <li class="<?php echo (($url == "index" || $url == "view" || $url == "add" || $url == "globalmessage" ) && $ctrl == "conversations") ? "active treeview" : "treeview"; ?>">
                    <a href="#">
                        <i class="fa fa-flag"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo ($ctrl == "conversations" && $url == "index" ) ? "active treeview" : "treeview"; ?>"><?php echo $this->Html->link("<i class=\"fa fa-flag\"></i> <span>Message</span>", ["controller" => "conversations", "action" => "index"], ["class" => "", "escape" => false]); ?></li>
                        <li class="<?php echo ($ctrl == "conversations" && $url == "globalmessage" ) ? "active treeview" : "treeview"; ?>"><?php echo $this->Html->link("<i class=\"fa fa-flag\"></i> <span>Global notification</span>", ["controller" => "conversations", "action" => "globalmessage"], ["class" => "", "escape" => false]); ?></li>
                    </ul>
                </li>
