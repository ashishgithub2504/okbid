            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-fw fa-circle-o"></i> <span
                            class="caption-subject font-green bold uppercase">Staffs</span></h3>
                    <div class="box-tools">
                        <?php echo $this->Html->link("<i class=\"fa fa-plus\"></i> " . __('Add Staff'), ["action" => "add"], ["class" => "btn btn-block btn-primary", "escape" => false]); ?>
                    </div>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $count=1; if (count($riders) > 0):
                            foreach ($riders as $key=>$rider): ?>
                            <tr>
                                <td><?= $count; ?></td>
                                <td><?= h($rider->name) ?></td>
                                <td><?= h($rider->role->name) ?></td>
