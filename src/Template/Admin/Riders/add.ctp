...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Add Staff') ?></h3>
        </div><!-- /.box-header -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('name', [ 'autocomplete' => 'off','class' => 'form-control','placeholder' => ucfirst('Name of Staff'), 'label' => ['text' => ucfirst('Name of Staff'),'class'=>'req']]); ?>
                    </div>
                </div>
		<div class="col-md-6">
                    <div class="form-group">         
