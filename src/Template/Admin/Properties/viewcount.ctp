        ...
        <div class="col-xs-12">
            <div class="box">
				...
				<td><?= $this->Html->link($property->user->name,['controller'=>'users','action'=>'view',$property->user->id]) . ' ' . ($role) ?></td>
                                ...
                                <td><?= !empty($property->property_view_count)?$property->property_view_count:0; ?></td>
                                <td><?= !empty($property->property_signature_count)?$property->property_signature_count:'0'; ?></td>
                                ...
                                <td class="actions">
                                    ...
                                    <?php if (in_array($this->request->session()->read('Auth.admin.role_id'), array('1','5'))) { ?>
                                        <?= $this->Html->link(__('<i class="fa fa-fw fa-eye"></i> Assign'), ['action' => 'assign', $property->id], ['data-toggle'=>"modal", 'data-target'=>"#myModal",'class' => 'btn  btn-warning btn-sm', 'escape' => false]) ?>
