...
<section class="content-header">
    <h1>
        ...
        <small>Update Horse Transfer Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit Horse Transfer') ?></h3>
        </div><!-- /.box-header -->
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('transfer_date', ['class' => 'form-control', 'placeholder' => ucfirst('transfer_date'), 'label' => ['text' => ucfirst('transfer_date'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('stable_name', ['class' => 'form-control', 'placeholder' => ucfirst('stable_name'), 'label' => ['text' => ucfirst('stable_name'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('person_name', ['class' => 'form-control', 'placeholder' => ucfirst('person_name'), 'label' => ['text' => ucfirst('person_name'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
