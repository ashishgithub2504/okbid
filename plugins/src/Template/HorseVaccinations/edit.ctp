...
<section class="content-header">
    <h1>
        ...
        <small>Update Horse Vaccination Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit Horse Vaccination') ?></h3>
        </div><!-- /.box-header -->
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('vaccination_date', ['class' => 'form-control', 'placeholder' => ucfirst('vaccination_date'), 'label' => ['text' => ucfirst('vaccination_date'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
