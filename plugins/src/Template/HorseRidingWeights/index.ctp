                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if ($horseRidingWeight->created != "") echo $horseRidingWeight->created->format('d-M-Y'); ?></td>
                                <td><?php if ($horseRidingWeight->modified != "") echo $horseRidingWeight->modified->format('d-M-Y'); ?></td>
                                <td class="actions">
