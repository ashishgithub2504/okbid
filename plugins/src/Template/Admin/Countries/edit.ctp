...
<section class="content-header">
    <h1>
        Manage Countries 
        <small>Update Country Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        ...
        <?php echo $this->Form->create($country, ['id'=>'validateform','role' => 'form', 'enctype' => 'multipart/form-data']); ?>
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('iso_code_2', ['class' => 'form-control', 'placeholder' => ucfirst('iso_code_2'), 'label' => ['text' => ucfirst('iso_code_2'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
