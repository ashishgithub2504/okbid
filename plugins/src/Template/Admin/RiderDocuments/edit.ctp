...
<section class="content-header">
    <h1>
        ...
        <small>Update Rider Document Details</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?= __('Edit Rider Document') ?></h3>
        </div><!-- /.box-header -->
        <?php echo $this->Form->create($riderDocument, ['id'=>'validateform','role' => 'form', 'enctype' => 'multipart/form-data']); ?>
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">         
                        <?php echo $this->Form->input('document', ['class' => 'form-control','type'=>'file', 'placeholder' => ucfirst('document'), 'label' => ['text' => ucfirst('document'),'class'=>'req']]); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">         
