...
/**
 * ChildsGuardiansFixture
 *
 */
class ChildsGuardiansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_login' => ['type' => 'integer', 'length' => 50, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
