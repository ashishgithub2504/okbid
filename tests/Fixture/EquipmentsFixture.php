...
class EquipmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'location' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'image' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2018-01-18 17:21:04',
            'modified' => '2018-01-18 17:21:04'
        ],
    ];
}
