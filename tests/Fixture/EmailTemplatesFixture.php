...
class EmailTemplatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_html' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '1', 'comment' => '', 'precision' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
            'email_templates_pk' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'is_html' => 1,
            'created' => '2017-05-03 08:53:40',
            'modified' => '2017-05-03 08:53:40'
        ],
    ];
}
