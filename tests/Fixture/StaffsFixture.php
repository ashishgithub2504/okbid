...
class StaffsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mobile' => ['type' => 'integer', 'length' => 50, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-10-29 06:39:28',
            'modified' => '2017-10-29 06:39:28'
        ],
    ];
}
