 ...
 *
 */
class HorseWeightsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'weight' => ['type' => 'integer', 'length' => 250, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2018-01-27 11:13:23',
            'modified' => '2018-01-27 11:13:23'
        ],
    ];
}
