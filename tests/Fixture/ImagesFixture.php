...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => true, 'default' => '1', 'comment' => '1- gallery, 2- banner', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'modified' => '2017-05-05 06:25:12',
            'created' => '2017-05-05 06:25:12'
        ],
    ];
}
