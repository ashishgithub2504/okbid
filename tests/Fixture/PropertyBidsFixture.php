 ...
 *
 */
class PropertyBidsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'integer', 'length' => 100, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'price' => 1,
            'created' => '2018-07-29 09:49:48',
            'modified' => '2018-07-29 09:49:48'
        ],
    ];
}
