...
class PagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'meta_keyword' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2017-05-03 08:53:55',
            'modified' => '2017-05-03 08:53:55'
        ],
    ];
}
