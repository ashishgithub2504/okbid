 ...
 *
 */
class HorseTravelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'travel_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2018-01-27 11:14:29',
            'modified' => '2018-01-27 11:14:29'
        ],
    ];
}
