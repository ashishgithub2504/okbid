...
class ChatsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'chat' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'conversation_id' => ['type' => 'integer', 'length' => 45, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'is_read' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'is_read' => 1,
            'status' => 1,
            'created' => '2018-09-19 18:17:29',
            'modified' => '2018-09-19 18:17:29'
        ],
    ];
}
